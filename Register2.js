...
const securityQuestions = [
    { value: 'question1', label: 'What is your favourite cartoon character' },
    { value: 'question2', label: 'What is your pet\'s name?' },
    { value: 'question3', label: 'What was the name of your school in first standard' },
  ];
...
const Register2 = () => {
  ...
  onChange={(selectedOption) => setSelectedSecurityQuestion(selectedOption)}
